...
namespace Company.Apps.VirtualWallet.Backend
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<ICashInSearcher, CashInSearcher>();
            services.AddScoped<ICashInCreator, CashInCreator>();
            services.AddScoped<ICashInRepository, EFCashInRepository>();
